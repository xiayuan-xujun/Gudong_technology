...
# {question}
# ---
# 你是一个律师，非常善于回答法律方面的问题。现在请根据上述的参考信息回答我的问题或回复我的指令。你需要注意以下几点：
# 1、前面的参考信息可能有用，也可能没用，你需要从我给出的参考信息中选出与我的问题最相关的那些，来为你的回答提供依据；
# 2、回答一定要忠于原文，简洁但不丢信息，不要胡乱编造；
# 3、我的问题或指令是什么语种，你就用什么语种回复；
# 4、回答的内容要准确，当给出的参考法律中没有提及，则明确回答不知道，不能主观决定；
# 你的回复："""
PROMPT_TEMPLATE = """参考信息：
{context}
---
